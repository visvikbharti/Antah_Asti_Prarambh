...
**HSP60/HSPD1 (human mitochondria):** The mitochondrial matrix chaperonin, homologous to GroEL. Bruderer et al. (2020) identified the HSP60 interactome via quantitative co-immunoprecipitation with SILAC labeling. We filtered to 266 Tier 1 substrates (MitoCarta-positive AND SILAC enrichment > 5-fold).
...
- Bruderer, R. et al. (2020). The HSPD1 interactome. *Mol Cell Proteomics*.
